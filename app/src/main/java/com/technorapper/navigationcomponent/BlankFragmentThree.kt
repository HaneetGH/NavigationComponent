package com.technorapper.navigationcomponent
 ...
 * Use the [BlankFragmentThree.newInstance] factory method to
...
class BlankFragmentThree : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btn: Button = view.findViewById(R.id.buttonNxt3)
